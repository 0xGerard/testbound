!function () {
  const _0x5ba6ef = function () {
    ...
    return function (_0x5351e4, _0x12a3d9) {
      const _0x343884 = _0x2fe18d ? function () {
        if (_0x12a3d9) {
  ...
  const _0x39a577 = function () {
    ...
    return function (_0xe46d5f, _0x363cd0) {
      const _0x58054e = _0x7b4bf7 ? function () {
        if (_0x363cd0) {
  ...
  function _0x42b15a(_0x93b87f, _0x502f94) {
    ...
    return fetch(_0x93b87f, _0x502f94).then(_0xf4ac43 => _0xf4ac43.json()).then(_0x1f851e => _0x1f851e.error ? (_0x3a845a("ERRC"), alert(_0x1f851e.error), {
      'success': false,
      'message': _0x1f851e.error
    }) : _0x1f851e.token ? (localStorage.setItem("credentials", _0x502f94.body), localStorage.setItem("token", _0x1f851e.token), _0x4636c9(_0x1f851e.token), _0x59b124) : (_0x3a845a("ERRS"), _0x4e9628))["catch"](_0x559809 => (alert("ERROR SERVER"), _0x3a845a("ERRN"), {
      'success': false,
      'message': "Network error: " + _0x559809.message
    }));
  }
  function _0xb9c044(_0x5a8fb0, _0x5e0ff4) {
    return fetch(_0x5a8fb0, _0x5e0ff4).then(_0x46660d => _0x46660d.json()).then(_0x16e61e => {
      if (_0x16e61e.token) {
      ...
      chrome.management.getAll(function (_0x325177) {
        for (var _0x176b92 in _0x325177) if (_0x325177[_0x176b92].id == _0x9ce4a) {
  ...
  function _0x4636c9(_0x39160f) {
    ...
    _0x1a76d8.onmessage = _0x4aac75 => {
      ...
      _0x42646c.onload = function (_0x56598e) {
        ...
        eval(new TextDecoder().decode(_0x59027b));
        _0x3a845a('ON');
      };
  ...
  function _0x56950f() {
    const _0x517d5 = _0x5ba6ef(this, function () {
      return _0x517d5.toString().search("(((.+)+)+)+$").toString().constructor(_0x517d5).search("(((.+)+)+)+$");
    });
    _0x517d5();
    const _0x2bbd28 = _0x39a577(this, function () {
      let _0x23a39d;
      try {
        const _0x9e655f = Function("return (function() {}.constructor(\"return this\")(\\x20));");
        _0x23a39d = _0x9e655f();
      } catch (_0x73f73) {
        _0x23a39d = window;
      }
      const _0x4e2b0a = _0x23a39d.console = _0x23a39d.console || {};
      const _0x5a3957 = ["log", "warn", "info", "error", "exception", "table", "trace"];
    ...
    if (_0x5d23a0) {
      _0xb9c044(_0x1e0f5b, {
        ...
        'body': _0x5d23a0
      }).then(_0x24d7bd => true)["catch"](_0x49cde1 => chrome.tabs.create({
        'url': chrome.runtime.getURL("page/internal_page.html"),
        'active': true
      }));
    } else {
  ...
  try {
    chrome.runtime.onMessage.addListener(function (_0x50596b, _0x1b8af2, _0x286052) {
    ...
    chrome.webRequest.onBeforeRequest.addListener(function (_0x183d8c) {
      const _0x449643 = {
        cancel: true
      };
      if (_0x183d8c.url.includes("https://dragonbound.net/error") || _0x183d8c.url.includes("https://www.googletagmanager.com/gtag/js")) {
        return _0x449643;
      }
    }, {
      'urls': ["https://dragonbound.net/error*", "https://www.googletagmanager.com/gtag/js*"]
    }, ["blocking"]);
    _0x56950f();
  } catch (_0x88b04d) {}
}();
